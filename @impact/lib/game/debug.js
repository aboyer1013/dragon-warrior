		...
		CustomPanel = ig.DebugPanel.extend({
			...
			load: function( game ) {
				...
				if (hero.length) {
					...
					output += ln('anim UP: ', hero.currentAnim === hero.anims.UP);
					output += ln('anim RIGHT: ', hero.currentAnim === hero.anims.RIGHT);
					output += ln('anim DOWN: ', hero.currentAnim === hero.anims.DOWN);
					output += ln('anim LEFT: ', hero.currentAnim === hero.anims.LEFT);
					output += ln('anim FADEIN_UP: ', hero.currentAnim === hero.anims.FADEIN_UP);
				}
				this.container.innerHTML = outputPrefix + output + outputSuffix;
			},
