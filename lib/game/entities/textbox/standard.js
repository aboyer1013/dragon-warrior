	...
	.defines(function () {
		...
		ig.global.TextBox.Standard = ig.global.Entity.extend({
			...
			updateContent: function (newContent) {
				...
				// _.assign(this.selector, this.getDefaultSelectorPos());
				this.draw(true);
			},
			...
			getDefaultSelectorPos: function () {
				...
				pos.x = pos.x - (this.hasMenuItems() ? this.tileSize : 0) + (this.indent * this.tileSize);
				return _.assign({}, {pos:pos, settings:settings});
			},
